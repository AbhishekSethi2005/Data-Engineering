...
# Load the Silver customer source
...
# Project the fields needed downstream
...
# Load the Silver product source
...
# Build the promotion dimension
# Load the Silver sales source
...
# Inspect promotion-related fields
...
# Derive the distinct promotion records
from pyspark.sql.functions import col
...
# Assign a promotion surrogate key
...
# Arrange the dimension columns in output order
from pyspark.sql.functions import col
...
# Derive the distinct calendar dates
from pyspark.sql.functions import col
...
# Build the central sales fact table
# Load the published Gold dimensions
...
# Attach the customer dimension key
...
# Attach the product dimension key
...
# Attach the promotion dimension key
fact_sales = fact_sales.join(
...
# Choose the fact-table measures and keys
from pyspark.sql.functions import col
...
# Persist the completed fact table
fact_sales.write \
    .format("delta") \
    .mode("overwrite") \
    .option("overwriteSchema", "true") \
...
# Test relationships between facts and dimensions
from pyspark.sql.functions import countDistinct
...
# KPI 1: regional sales comparison
...
# KPI 2: promotion-level average order value
...
# KPI 3: customer churn by demographic group
...
# KPI 5: transaction activity by hour
from pyspark.sql.functions import count
